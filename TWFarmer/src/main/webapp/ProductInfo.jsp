...
<body>
 ...
 -->
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="panel-385033"></div>
						<div class="tab-pane" id="panel-385032">
							<form action="<c:url value="/Order/NewOrderServlet"/>" method="POST">
								...
								<input type="hidden" name="sellerID" value="1003">
		...
		<div class="row">
			...
			<div class="col-md-3">
				...
				<button type="submit" class="btn btn-default btn-block active">
					直接購買</button>
			</div>
			<div class="col-md-3">
