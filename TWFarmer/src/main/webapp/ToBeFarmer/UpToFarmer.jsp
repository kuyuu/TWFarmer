...
<body>
		...
		<div class="col-md-8">
			<div class="row jumbotron">
				...
				<form action="<c:url value="NewFarmerServlet" />" method="post">
					...
					<div class="form-group">
						<label for="">銀行代碼</label> <select class="form-control"
							name="bank" id="bank">
	...
	<script>
		...
		function insertfile() {
			...
			$("#farmerIntro")
					.val(
							'在種滿四季水果的吉田觀光果園中，可以享受賞花、採果、採菜的樂趣，體驗難得的鄉村生活，尤其大人帶著小孩在果園、菜園透過實際行動體驗採收活動。園中所產水果的果粒都十分大顆，果園一旁則栽種了青翠蔬菜，通通可以讓遊客帶回家。入園不收取清潔管理費，外帶則依市價論斤計算。另有精美禮盒包裝，送禮大方實惠。');
		}
	</script>
</body>
</html>