	...
	<c:if test="${not empty LoginOK }">
		<div class="panel panel-default">
			...
			<div id="collapseOne" class="panel-collapse collapse in"
				...
				<ul class="list-group">
					<li class="list-group-item"><a href="../BackStage/WelcomeMember.jsp">管理個人資料</a></li>
					<li class="list-group-item"><a href="#">管理訂單</a></li>
					<li class="list-group-item"><a href="../BackStage/MemberCheckJpServlet">管理開團</a></li>
					<li class="list-group-item"><a href="../BackStage/MemberCheckJpFollowerServlet">管理跟團</a></li>
					<li class="list-group-item"><a href="#">追蹤商品</a></li>
		...
		<c:if test="${LoginOK.idType==2}">
			<div class="panel panel-default">
				...
				<div id="collapseTwo" class="panel-collapse collapse"
					...
					<ul class="list-group">
						<li class="list-group-item"><a href="../BackStage/BackStageServlet">管理商品</a></li>
						<li class="list-group-item"><a href="../BackStage/SelectAllQnaServlet">商品問與答</a></li>
						<li class="list-group-item"><a href="../BackStage/FarmerCheckJpServlet">審核合購</a></li>
