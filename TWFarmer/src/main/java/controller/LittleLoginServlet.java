...
@WebServlet(urlPatterns = { "/LittleLogin.controller" })
public class LittleLoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 然後 return
		if (!errors.isEmpty()) {
			RequestDispatcher rd = request.getRequestDispatcher("/common/menu.jsp");
