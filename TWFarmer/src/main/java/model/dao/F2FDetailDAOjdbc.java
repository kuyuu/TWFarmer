...
//		f2fDetailInsert.setF2fTime(java.sql.Timestamp.valueOf("2017-01-31 18:20:00"));
//		
...
//		f2fDetailUpdate.setF2fTime(java.sql.Timestamp.valueOf("2017-01-31 10:30:00"));
//		
...
//	}
	...
	private static final String SELECT_BY_ID =
			"select * from F2FDetail where F2FId=?";
	@Override
	...
	private static final String INSERT =
			"insert into F2FDetail (JPID, F2FPlace, F2FTime) values (?,?,?)";
	@Override
	...
	private static final String DELETE =
			"DELETE FROM F2FDetail where F2FID=?";
	@Override
